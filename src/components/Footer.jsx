        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-white">Catogories</p>
              <nav class="mt-8">
                <ul class="space-y-1 text-sm flex  flex-col flex-wrap items-center gap-[1.2vw] justify-center">
                  {/* Render the first six categories */}
                  {apiData.slice(0, 6).map((item, index) => (
                    <li key={index} class="">
                      <Link
                        className="lg:text-[1vw] text-center  hover:border decoration-transparent text-white"
                        to={`/${item}`}>
                        {item}
                      </Link>
                    </li>
            ...
            <div class="text-center sm:text-left ">
              <p class="text-lg font-medium text-white">Payments</p>

              <nav class="mt-4">
                <ul class="space-y-3 text-sm  ml-[2vw] ">
                  {[
                    ...
                    "https://vectorseek.com/wp-content/uploads/2023/09/SadaPay-Logo-Vector.svg-.png",
